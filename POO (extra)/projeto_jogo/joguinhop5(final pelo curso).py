'''
implementando random para um dano variado
'''
...
class Personagem:
    ...
    def atacar(self, alvo):
        ...
        dano = randint(self.__level * 2, self.__level * 4)
...
class Heroi(Personagem):
    ...
    #cria o especial do herói
    def especial(self, alvo):
        #definindo o dano causado
        dano = randint(self.level * 5, self.level * 8)
        #mensagem de exibição.
        print(f'{self.nome} usou o especial {self.habilidade} em {alvo.nome} e causou {dano} de dano')
        return dano
...
class Jogo:
    ...
    def __init__(self):
        ...
        self.heroi_principal = Heroi(nome='Heron', vida=100, habilidade='Dedada no Caneco', level=5)
    ...
    def iniciar_batalha(self):
        ...
        while self.heroi_principal.vida > 0 and self.vilao_principal.vida > 0:
            ...
            if escolha == '1':
                ...
                self.vilao_principal.receber_dano(self.heroi_principal.especial(self.vilao_principal))
            else:
                print('resposta inválida! Vai tomar uma pra ficar ligeiro!')
            
            #se o vilão ainda estiver vivo
            if self.vilao_principal.vida > 0:
                #vilão ataca herói
                self.heroi_principal.receber_dano(self.vilao_principal.atacar(self.heroi_principal))
